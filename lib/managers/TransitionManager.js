export default class TransitionManager {
    ...
    startTransition(fromScreen, toScreen, callback = null) {
        ...
        if (!this.transitionImage) {
            ...
            this.transitionImage.filter = NEAREST;
        }
    ...
    render() {
        if (!this.isTransitioning || !this.transitionImage || this.transitionImage.width === 0) {
            return;
        }
    ...
    _renderTile(x, y, width, height, scaledWidth, scaledHeight, progress) {
        ...
        if (width < this.tileWidth || height < this.tileHeight) {
            ...
            finalWidth = scaledWidth * widthRatio;
            finalHeight = scaledHeight * heightRatio;
        } else {
        ...
        this.transitionImage.draw(drawX, drawY, finalWidth, finalHeight);
    }
