...
export default class SpriteSheetAnimation {
  /**
   * @param {string} imagePath - Path to the spritesheet PNG.
   ...
   */
  constructor(imagePath, rects, fps) {
    this.sheet = new Image(imagePath);
    this.sheet.filter = NEAREST; // crisp pixels
